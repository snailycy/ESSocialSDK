            ...
            public void run() {
                try {
                    ...
                    try {
                        ...
                        SocialToken token = new SocialToken(info.getString("openid"), info.getString("unionid"), info.getString("access_token"), info.getString("refresh_token"), /*info.getLong("expires_in")*/ 30 * 24 * 60 * 60);
